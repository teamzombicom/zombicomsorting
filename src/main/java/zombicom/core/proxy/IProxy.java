...
public interface IProxy {
     ...
     * this was where block, item, etc. were registered. There are still things
     ...
     * for registering things that depend on things in pre-init from other mods (like recipes,
    ...
    /**
     * Fml life cycle event Post Initialization. This phase is useful For doing inter-mod stuff
     * like checking which mods are loaded or if you want a complete view of things across mods
     * like having a list of all registered item to aid random item generation.
     *
     * @param event the event
     */
